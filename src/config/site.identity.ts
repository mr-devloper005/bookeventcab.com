export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'bookeventcab',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Bookeventcab',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'bookeventcab.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://bookeventcab.com',
